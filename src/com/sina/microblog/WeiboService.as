...
//			_save_token = save_token;
		...
		public function commentsToMe(since_id:int = 0, max_id:int = 0, count:int = 50, page:int = 1, filter_by_author:int = 0, filter_by_source:int = 0):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_TO_ME,
					params : {since_id: since_id, max_id: max_id, count: count, page: page, filter_by_author: filter_by_author, filter_by_source: filter_by_source}, 
					method : "GET",
					rE : WeiboServiceEvent.COMMENTS_TO_ME_RESULT,
					eE : WeiboServiceEvent.COMMENTS_TO_ME_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function commentsTimeline(since_id:int = 0, max_id:int = 0, count:int = 50, page:int = 1):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_TIMELINE,
					params : {since_id: since_id, max_id: max_id, count: count, page: page}, 
					method : "GET",
					rE : WeiboServiceEvent.COMMENTS_TIMELINE_RESULT,
					eE : WeiboServiceEvent.COMMENTS_TIMELINE_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function commentsMentions(since_id:int = 0, max_id:int = 0, count:int = 50, page:int = 1, filter_by_author:int = 0, filter_by_source:int = 0):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_MENTIONS,
					params : {since_id: since_id, max_id: max_id, count: count, page: page, filter_by_author: filter_by_author, filter_by_source: filter_by_source}, 
					method : "GET",
					rE : WeiboServiceEvent.COMMENTS_MENTIONS_RESULT,
					eE : WeiboServiceEvent.COMMENTS_MENTIONS_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 */		
		public function commentsShowBatch(cids:String):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_SHOW_BATCH,
					params : {cids: cids}, 
					method : "GET",
					rE : WeiboServiceEvent.COMMENTS_SHOW_BATCH_RESULT,
					eE : WeiboServiceEvent.COMMENTS_SHOW_BATCH_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 */		
		public function commentsCreate(comment:String, id:String, comment_ori:int = 0):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_CREATE,
					params : {comment: comment, id:id, comment_ori:comment_ori}, 
					method : "POST",
					rE : WeiboServiceEvent.COMMENTS_CREATE_RESULT,
					eE : WeiboServiceEvent.COMMENTS_CREATE_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 */		
		public function commentsDestroy(cid:String):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_DESTROY,
					params : {cid: cid}, 
					method : "POST",
					rE : WeiboServiceEvent.COMMENTS_DESTROY_RESULT,
					eE : WeiboServiceEvent.COMMENTS_DESTROY_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 */		
		public function commentsDestroyBatch(ids:String):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_DESTROY_BATCH,
					params : {ids: ids}, 
					method : "POST",
					rE : WeiboServiceEvent.COMMENTS_DESTROY_BATCH_RESULT,
					eE : WeiboServiceEvent.COMMENTS_DESTROY_BATCH_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 */		
		public function commentsReply(cid:String,ids:String,comment:String,without_mention:int = 0,comment_ori:int = 0):void
		{
			var obj:Object = {
				uri : ServiceAPI.COMMENTS_REPLY,
					params : {cid: cid, ids: ids, comment: comment, without_mention: without_mention, comment_ori: comment_ori}, 
					method : "POST",
					rE : WeiboServiceEvent.COMMENTS_REPLY_RESULT,
					eE : WeiboServiceEvent.COMMENTS_REPLY_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 * <b>参数uid与screen_name二者必选其一，且只能选其一</b>
		 * 使用screen_name调用此接口可以匿名调用。
		 */		
		public function usersShow(uid:String = null, screen_name:String = null):void
		{
			var params:Object = {};
			var anonymousAPI:Boolean = false;
			if(uid != null){
				params.uid = uid;
			...
			var obj:Object = {
				uri : ServiceAPI.USERS_SHOW,
					params : params, 
					method : "GET",
					rE : WeiboServiceEvent.USERS_SHOW_RESULT,
					eE : WeiboServiceEvent.USERS_SHOW_ERROR
			};
			addToAPICallingSequence(obj, anonymousAPI);
		}
		
		public function domainShow(domain:String):void
		{
			var obj:Object = {
				uri : ServiceAPI.DOMAIN_SHOW,
					params : {domain: domain}, 
					method : "GET",
					rE : WeiboServiceEvent.DOMAIN_SHOW_RESULT,
					eE : WeiboServiceEvent.DOMAIN_SHOW_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function usersCounts(uids:String):void
		{
			var obj:Object = {
				uri : ServiceAPI.USERS_COUNTS,
					params : {uids: uids}, 
					method : "GET",
					rE : WeiboServiceEvent.USERS_COUNTS_RESULT,
					eE : WeiboServiceEvent.USERS_COUNTS_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function friendshipsFriends(uid:String, screen_name:String, count:int = 50, cursor:int = 0):void
		{
			var params:Object = {};
			params.count = count;
			params.cursor = cursor;
			if(uid != null) params.uid = uid;
			else if(screen_name != null) params.screen_name = screen_name;
			var obj:Object = {
				uri : ServiceAPI.FRIENDSHIPS_FRIENDS,
					params : params, 
					method : "GET",
					rE : WeiboServiceEvent.FRIENDSHIPS_FRIENDS_RESULT,
					eE : WeiboServiceEvent.FRIENDSHIPS_FRIENDS_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function friendshipsInCommon(uid:String, suid:String = null, count:int = 50, page:int = 1):void
		{
			var params:Object = {};
			params.count = count;
			params.page = page;
			params.uid = uid;
			if(suid != null) params.suid = suid;
			var obj:Object = {
				uri : ServiceAPI.FRIENDSHIPS_IN_COMMON,
					params : params, 
					method : "GET",
					rE : WeiboServiceEvent.FRIENDSHIPS_IN_COMMON_RESULT,
					eE : WeiboServiceEvent.FRIENDSHIPS_IN_COMMON_ERROR
			};
			addToAPICallingSequence(obj);
		}
		 ...
		 * 
		 */		
		public function friendshipsBilateral(uid:String, count:int = 50, page:int = 1, sort:int = 0):void
		{
			var obj:Object = {
				uri : ServiceAPI.FRIENDSHIPS_BILATERAL,
					params : {uid: uid, count: count, page: page, sort: sort}, 
					method : "GET",
					rE : WeiboServiceEvent.FRIENDSHIPS_BILATERAL_RESULT,
					eE : WeiboServiceEvent.FRIENDSHIPS_BILATERAL_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function friendshipsBilateralIds(uid:String, count:int = 50, page:int = 1, sort:int = 0):void
		{
			var obj:Object = {
				uri : ServiceAPI.FRIENDSHIPS_BILATERAL_IDS,
					params : {uid: uid, count: count, page: page, sort: sort}, 
					method : "GET",
					rE : WeiboServiceEvent.FRIENDSHIPS_BILATERAL_IDS_RESULT,
					eE : WeiboServiceEvent.FRIENDSHIPS_BILATERAL_IDS_ERROR
			};
			addToAPICallingSequence(obj);
		}
		
		public function friendshipsIds(uid:String = null, screen_name:String = null, count:int = 500, cursor:int = 0):void
		{
			var params:Object = {};
			params.count = count;
			params.cursor = cursor;
			...
			var obj:Object = {
				uri : ServiceAPI.FRIENDSHIPS_IDS,
					params : params, 
					method : "GET",
					rE : WeiboServiceEvent.FRIENDSHIPS_IDS_RESULT,
					eE : WeiboServiceEvent.FRIENDSHIPS_IDS_ERROR
			};
			addToAPICallingSequence(obj);
		}
